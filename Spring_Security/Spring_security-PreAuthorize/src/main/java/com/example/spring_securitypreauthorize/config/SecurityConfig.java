package com.example.spring_securitypreauthorize.config;

import com.example.spring_securitypreauthorize.service.PersonDetailsService;
...
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true) // анотация которая включает роли на уровне методов
