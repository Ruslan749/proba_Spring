...
public class PersonDAO {
    ...
    */
    ...
    // перегруженный метод для валидации email
//    Optional -- объект, который может возвратиться, а может и не возвратиться
    ...
    */
    ...
    public List<Person> create1000People(){
        ...
        for (int i = 0; i < 1000; i++){
            people.add(new Person(i,"Name" + i, 30, i + "@mail.ru", "som address"));
        }
